...
local workspace_dir = vim.env.HOME .. '\\Workspaces\\md\\develop-3.3.x\\IGS-PRODUCT' 
...
local config = {
  ...
  settings = {
    java = {
      ...
      home = 'C:\\Program Files\\Java\\jdk-22.0.1',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-22",
            path = "C:\\Program Files\\Java\\jdk-22.0.1",
          },
        }
      },
      maven = {
        downloadSources = true,
        userSettings = 'C:\\apache-maven-3.9.4\\igs-settings-servers.xml'
      },
